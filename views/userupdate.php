...
<html lang="en" data-bs-theme="auto">
    ...
    <body data-bs-theme="dark" class="d-flex align-items-center py-4">
        <main class="form-signin w-100 m-auto">
            <form name="adminactualizar" action="../updateuser/<?php echo $code ?>" method="post">
                <img
                    class="mb-4"
                ...
                ?>
                <h1 class="h3 mb-3 fw-normal">Update: <?php echo $username; ?></h1>
                <?php
